            ...
            <div className="container mx-auto px-4 md:px-6 py-12">
                <Card className="max-w-4xl mx-auto">
                    ...
                    <CardContent className="prose dark:prose-invert">
                        ...
                        <p>Welcome to GetFixam Ghana. These terms and conditions outline the rules and regulations for the use of GetFixam Ghana's Website, located at your-domain.com.</p>
                        <h2>2. Intellectual Property Rights</h2>
                        <p>Other than the content you own, under these Terms, GetFixam Ghana and/or its licensors own all the intellectual property rights and materials contained in this Website.</p>
