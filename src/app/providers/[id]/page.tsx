...
import { Phone, MessageCircle, CheckCircle, MapPin, Home, Plus, Star, Send } from 'lucide-react';
    ...
    <PublicLayout>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t bg-background p-3 md:hidden">
        <div className="container mx-auto flex items-center gap-3">
          <ContactButton provider={provider} type="call" className="w-1/3" variant="outline">
            <Phone className="mr-2 h-4 w-4" />
            Call
          </ContactButton>
          <ContactButton provider={provider} type="whatsapp" className="w-1/3">
            <MessageCircle className="mr-2 h-4 w-4" />
            WhatsApp
          </ContactButton>
          <div className="w-1/3">
